...
?>
	<tr>
		...
		<td><img src="//<?php echo $domain; ?>/inc/img/char_bg.png" alt="Image of <?php echo $row[1]; ?>" id="image_<?php echo $row[0]; ?>" width="271px" height="162px" /><br/>
		<pre><?php echo $domain; ?>/card/<?php echo $row[1]; ?></pre></td>
		<td><img src="//<?php echo $domain; ?>/inc/img/stat_window.png" alt="Statistics of <?php echo $row[1]; ?>" id="stats_<?php echo $row[0]; ?>" width="192px" height="345px" /><br/>
		<pre><?php echo $domain; ?>/infopic/<?php echo $row[1]; ?></pre></td>
	</tr>
<?php
}
