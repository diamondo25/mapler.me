<?php include_once('inc/header.php'); ?>
	...
	<div class="featurette">
        <img class="featurette-image pull-right" src="http://i.imm.io/NXWz.png">
    ...
    <div class="featurette">
        <img class="featurette-image pull-left" src="http://i.imm.io/NViS.png">
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="http://i.imm.io/NZGP.png">
