...
<div class="status">
	...
	socialize with other maplers, and keep up to date on the latest updates from MapleStory.</p>
	<p>While exploring Mapler.me, you'll be able to participate with the dozens of other maplers apart of our network. Our goal is to make Mapler.me as MapleStory-like
...
$q->free();
?>
	<h1>#2 <small>Now onward to the next spot, <span class="muted">making the most of Mapler.me.</span></small></h1>
	<p>
	...
	<p>Before using the client, to protect other MapleStory player's characters, you are required to <a href="//<?php echo $domain; ?>/settings/accounts/">connect your Mapler.me account to a Nexon America account</a>.
	More information about this can be found in our FAQ.<br/>
	<sup>*After successfully connecting a character, Nexon America is alerted that you've connected your account to Mapler.me for monitoring purposes.</sup></p>
</div>

<div class="status">
	<h1>#3 <small>Seems you're all set, <span class="muted">what's next?</span></small></h1>
	<p><img src="http://cdn.mapler.me/etc/resources/bing.png" class="pull-right"/> Congrats! If you connected your account, you can now start adding your characters and show off that new Zakum Helmet you scrolled! If not, that's perfectly fine; you can continue to use Mapler.me without playing MapleStory. Some of these unrelated features will be discussed later in the guide.</p>
...
<div class="status">
	...
	<p><img src="http://puu.sh/2sUL7" class="pull-right" /> When you first launch the client, it will great you with a notice asking to launch MapleStory.</p>
	...
	<ul style="list-style-image: url(http://cdn.mapler.me/etc/resources/medal.png);margin-left:40px;">
		...
		As soon as Mapler.me has recieved a response that MapleStory has successfully loaded, it will pause. Mapler.me will resume as soon as you've selected a channel, and presented with your characters.
		<li><b>"Successfully connected to servers or Cash Shop"</b></li>
		This is shown when you've finally selected a character although it hasn't fully loaded (that black screen, f2). This is also shown when your character is in the Cash
		...
		If everything has gone perfectly, you will be presented with this notification (except with your character's name)! If you refresh your <a href="//<?php echo $_loginaccount->GetUsername(); ?>.<?php echo $domain; ?>/">profile</a> or <a href="//<?php echo $domain; ?>/settings/characters/">characters settings page</a>
</div>
...
?>
    ...
    <div class="featurette">
        <img class="featurette-image pull-left" src="//i.imm.io/NViS.png">
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="//i.imm.io/NZGP.png">
