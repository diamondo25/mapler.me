...
<div class="status">
	...
	<p><span class="pull-right" style="border-left:1px solid rgba(0,0,0,0.3);padding-left:10px;margin-left:10px;">You:<br/><?php MakePlayerAvatar($__login_main_character['name'], $__login_main_character['locale']); ?></span> You've now gotten the basics of Mapler.me! There are many other features to the site such as social statuses, profiles, and friends, but you'll have to discover those yourself. If you've successfully added a character, you will see your character to the right!</p>
