		...
		<footer>
			<p><span>&copy; 2012-<?php echo date('Y'); ?> Mapler.me</span></p>
			<p><a href="//status.mapler.me">Status</a> - <a href="//<?php echo $domain; ?>/support/">Request Support</a> - <a href="//<?php echo $domain; ?>/faq/">FAQ</a></p>
			<br />
