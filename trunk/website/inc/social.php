...
<div class="row">
			...
			<form method="post">
					<div class="span9">
					<textarea name="content" id="content" class="span9 status" style="height:100px;max-height:100px;max-width:888px;padding-right:50px;" placeholder="Type your status here!"></textarea>
					</div>
