...
<?php if ($row['comments_disabled'] == '0'): ?>
					<a href="//<?php echo $domain; ?>/stream/status/<?php echo $row['social_statuses.id']; ?>#disqus_thread"></a>
...
<?php endif; ?>
					...
					<span class="pull-right">
						<a href="//<?php echo $domain; ?>/stream/status/<?php echo $row['social_statuses.id']; ?>"><?php echo time_elapsed_string($row['secs_since']); ?> ago</a>
...
?></h1>
		...
		<p>Step 1) To begin using Mapler.me, first head to <button class="btn" onclick="document.location.href = '//<?php echo $domain; ?>/settings/accounts/'">Settings -&gt; Accounts</button> and connect your Nexon America account with Mapler.me. When logging into
