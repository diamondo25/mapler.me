...
?>
	<div class="row">
		<div class="span6">
			...
			<a href="http://cdn.mapler.me/installers/setup_1.0.0.10.exe" class="btn btn-success btn-large download-button">Download the latest client installer!</a>
			<br /><br />
			...
			<a href="http://wordpress.org/plugins/maplerme/" class="btn btn-success btn-large download-button">View plugin on Wordpress.org!</a><br /><br />
