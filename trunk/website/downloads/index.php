...
?>
	<div class="row">
		<div class="span6">
			...
			<a href="http://cdn.mapler.me/installers/setup_1.0.0.10.exe" class="btn btn-success btn-large download-button">Download the latest client installer!<br />(V 1.0.0.10)</a>
			<p>Note: WinPcap is required for the client to function correctly. This will be installed when you run the installer.</p>
